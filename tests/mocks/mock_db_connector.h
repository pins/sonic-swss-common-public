...
class MockDBConnector final : public DBConnectorInterface {
 public:
  ...
  MOCK_METHOD(std::vector<std::string>, keys, (const std::string& regex),
              (override));
  ...
  MOCK_METHOD(std::shared_ptr<std::string>, hget,
              (const std::string& key, const std::string& field), (override));
};
